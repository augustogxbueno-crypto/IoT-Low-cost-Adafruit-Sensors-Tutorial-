...
class AS7343Sensor : public SensorBase {
 public:
  bool begin() override;
  ...
  uint8_t channelCount() const override { return 13; }
  ...
  uint8_t gainOptionCount() const override { return 13; }
 ...
 private:
  Adafruit_AS7343 sensor_;
  uint8_t gainIdx_ = 9; // 256X (library default)
  int     atime_   = 100;
  int     astep_   = 999;
